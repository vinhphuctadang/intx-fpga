# 1 "intx-fpga/solution1/adder.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 395 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "intx-fpga/solution1/adder.cpp" 2
# 1 "intx-fpga/solution1/intx.hpp" 1
...
# 1 "intx-fpga/solution1/int128.hpp" 1
...
#pragma pack(pop)
# 10 "D:/Xillin/Vitis_HLS/2020.2/tps/mingw/6.2.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdlib.h" 2 3
...
# 8 "intx-fpga/solution1/int128.hpp" 2
...
# 9 "intx-fpga/solution1/int128.hpp" 2
...
# 10 "intx-fpga/solution1/int128.hpp" 2
...
# 32 "D:/Xillin/Vitis_HLS/2020.2/tps/mingw/6.2.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdint.h" 3
...
# 42 "D:/Xillin/Vitis_HLS/2020.2/tps/mingw/6.2.0/win64.o/nt\\lib\\gcc\\x86_64-w64-mingw32\\6.2.0\\include\\c++\\cstdint" 2 3
...
# 11 "intx-fpga/solution1/int128.hpp" 2
...
# 842 "D:/Xillin/Vitis_HLS/2020.2/tps/mingw/6.2.0/win64.o/nt\\x86_64-w64-mingw32\\include\\wchar.h" 3
...
# 111 "D:/Xillin/Vitis_HLS/2020.2/tps/mingw/6.2.0/win64.o/nt\\x86_64-w64-mingw32\\include\\sec_api/wchar_s.h" 3
...
# 13 "intx-fpga/solution1/int128.hpp" 2
...
# 15 "intx-fpga/solution1/int128.hpp" 2
# 65 "intx-fpga/solution1/int128.hpp"
namespace intx
{
...
# 282 "intx-fpga/solution1/int128.hpp"
...
# 553 "intx-fpga/solution1/int128.hpp"
}
...
# 594 "intx-fpga/solution1/int128.hpp"
...
{
    (void) ((!!(d & 0x8000000000000000)) || (_assert("d & 0x8000000000000000","intx-fpga/solution1/int128.hpp",606),0));
...
inline div_result<uint128> udivrem(uint128 x, uint128 y) noexcept
{
    if (y[1] == 0)
    {
        (void) ((!!(y[0] != 0)) || (_assert("y[0] != 0","intx-fpga/solution1/int128.hpp",714),0));
...
# 8 "intx-fpga/solution1/intx.hpp" 2
...
# 178 "D:/Xillin/Vitis_HLS/2020.2/tps/mingw/6.2.0/win64.o/nt\\x86_64-w64-mingw32\\include\\string.h" 3
}
...
# 69 "D:/Xillin/Vitis_HLS/2020.2/tps/mingw/6.2.0/win64.o/nt\\x86_64-w64-mingw32\\include\\sec_api/string_s.h" 3
}
# 182 "D:/Xillin/Vitis_HLS/2020.2/tps/mingw/6.2.0/win64.o/nt\\x86_64-w64-mingw32\\include\\string.h" 2 3
# 43 "D:/Xillin/Vitis_HLS/2020.2/tps/mingw/6.2.0/win64.o/nt\\lib\\gcc\\x86_64-w64-mingw32\\6.2.0\\include\\c++\\cstring" 2 3
...
# 12 "intx-fpga/solution1/intx.hpp" 2
...
{
    (void) ((!!(x != 0)) || (_assert("x != 0","intx-fpga/solution1/intx.hpp",464),0));
...
{
    (void) ((!!(len >= 2)) || (_assert("len >= 2","intx-fpga/solution1/intx.hpp",539),0));
...
{
    (void) ((!!(len >= 3)) || (_assert("len >= 3","intx-fpga/solution1/intx.hpp",563),0));
...
__attribute__((sdx_kernel("add", 0))) inline bool add(uint64_t s[], const uint64_t x[], const uint64_t y[], int len) noexcept
{
#pragma HLS TOP name=add
# 581 "intx-fpga/solution1/intx.hpp"


    (void) ((!!(len >= 2)) || (_assert("len >= 2","intx-fpga/solution1/intx.hpp",583),0));
    ...
    uint64_t r[], const uint64_t x[], const uint64_t y[], int len, uint64_t multiplier) noexcept
{
    ...
    (void) ((!!(len >= 1)) || (_assert("len >= 1","intx-fpga/solution1/intx.hpp",596),0));
...
{
    (void) ((!!(dlen >= 3)) || (_assert("dlen >= 3","intx-fpga/solution1/intx.hpp",613),0));
    (void) ((!!(ulen >= dlen)) || (_assert("ulen >= dlen","intx-fpga/solution1/intx.hpp",614),0));
...
# 818 "intx-fpga/solution1/intx.hpp"
template <unsigned N, typename T,
    typename = typename std::enable_if<std::is_convertible<T, uint<N>>::value>::type>
inline constexpr uint<N> operator|(const uint<N>& x, const T& y) noexcept
{
...
# 2 "intx-fpga/solution1/adder.cpp" 2
# 1 "intx-fpga/solution1/adder.h" 1
...
__attribute__((sdx_kernel("add", 0))) intx::uint<256> add(intx::uint<256> a, intx::uint<256> b);
# 3 "intx-fpga/solution1/adder.cpp" 2

__attribute__((sdx_kernel("add", 0))) intx::uint<256> add(intx::uint<256> a, intx::uint<256> b) {
#pragma HLS TOP name=add
# 4 "intx-fpga/solution1/adder.cpp"
